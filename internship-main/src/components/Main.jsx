...
function Main(props) {
	...
	return (
		<Container>
			<ShareBox>
				<div>
					<img src={props.user.photoURL || "/images/user.svg"} alt="User profile" />
			...
			<Content>
				{props.loading && <img src="/images/spin-loader.gif" alt="Loading spinner" />}
				{props.articles.length > 0 &&
					props.articles.map((article, key) => (
						<Article key={key}>
							<SharedActor>
								<a href="/services">
									<img src={article.actor.image || "/images/user.svg"} alt="Actor profile" />
									<div>
							...
							<SharedImage>
								<a href="https://www.example.com/resource" target="_blank" rel="noopener noreferrer">
							...
							<SocialCount>
								{props.articles[key].likes.count > 0 && (
									<>
										<li>
											<button>
												<img src="https://static-exp1.licdn.com/sc/h/d310t2g24pvdy4pt1jkedo4yb" alt="Likes icon" />
												<span>{props.articles[key].likes.count}</span>
											</button>
										</li>
										<li>
											<a href="/about">Comments (currently not working)</a>
										</li>
									</>
								)}
							</SocialCount>
							<SocialActions>
								<button
									...
									className={props.articles[key].likes.whoLiked.includes(props.user.email) ? "active" : null}
								>
